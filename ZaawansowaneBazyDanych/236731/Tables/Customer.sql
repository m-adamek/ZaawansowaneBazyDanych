...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[236731].[CustomerHistory], DATA_CONSISTENCY_CHECK=ON));
...
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress]
    ON [236731].[Customer]([EmailAddress] ASC);
